...
let s:lighter_black   = { "gui": "#ffffd7", "cterm": "250" }
let s:light_gray      = { "gui": "#A8A8A8", "cterm": "248" }
let s:lighter_gray    = { "gui": "#C6C6C6", "cterm": "255" }
...
let s:dark_blue       = { "gui": "#5f87af", "cterm": "24"   }
let s:blue            = { "gui": "#005fff", "cterm": "27"  }
let s:light_blue      = { "gui": "#b6d6fd", "cterm": "153" }
let s:dark_cyan       = { "gui": "#20A5BA", "cterm": "6"   }
let s:light_cyan      = { "gui": "#5fafaf", "cterm": "73"  }
let s:dark_green      = { "gui": "#10A778", "cterm": "2"   }
let s:light_green     = { "gui": "#5f875f", "cterm": "65"  }
...
call s:h("SpecialKey",    {"fg": s:dark_red})
call s:h("NonText",       {"fg": s:medium_gray})
call s:h("Directory",     {"fg": s:dark_red})
call s:h("ErrorMsg",      {"fg": s:red})
call s:h("IncSearch",     {"bg": s:dark_green, "fg": s:light_black})
call s:h("Search",        {"bg": s:light_green, "fg": s:light_black})
call s:h("MoreMsg",       {"fg": s:medium_gray, "cterm": "bold", "gui": "bold"})
hi! link ModeMsg MoreMsg
call s:h("LineNr",        {"fg": s:bg_subtle})
call s:h("CursorLineNr",  {"fg": s:cyan, "bg": s:bg_very_subtle})
...
call s:h("DiffText",      {"fg": s:dark_red})
call s:h("SignColumn",    {"fg": s:dark_red})


if has("gui_running")
  call s:h("SpellBad",    {"gui": "underline", "sp": s:red})
  call s:h("SpellCap",    {"gui": "underline", "sp": s:dark_red})
  call s:h("SpellRare",   {"gui": "underline", "sp": s:pink})
  call s:h("SpellLocal",  {"gui": "underline", "sp": s:dark_cyan})
else
  call s:h("SpellBad",    {"cterm": "underline", "fg": s:light_cyan})
  call s:h("SpellCap",    {"cterm": "underline", "fg": s:orange})
  call s:h("SpellRare",   {"cterm": "underline", "fg": s:pink})
  call s:h("SpellLocal",  {"cterm": "underline", "fg": s:dark_yellow})
endif
...
call s:h("CursorLine",    {"bg": s:bg_very_subtle, "cterm": "bold"})
call s:h("ColorColumn",   {"bg": s:bg_very_subtle})

call s:h("MatchParen",    {"bg": s:light_cyan, "fg": s:norm})
